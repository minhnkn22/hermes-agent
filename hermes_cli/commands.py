...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("opus", "Use Claude Opus conversation mode",
               "Configuration", args_hint="[prompt]"),
    CommandDef("sonnet", "Use Claude Sonnet conversation mode",
               "Configuration", args_hint="[prompt]"),
    CommandDef("fable", "Use Claude Fable conversation mode",
               "Configuration", args_hint="[prompt]"),
    CommandDef("exec", "Run one prompt through Codex/Hermes execution mode",
               "Configuration", args_hint="<prompt>", gateway_only=True),
